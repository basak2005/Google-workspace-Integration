...
@router.get("/")
def get_contacts(max_results: int = 100):
    """List all contacts"""
...
@router.get("/other")
def other_contacts(max_results: int = 100):
...
def get_contact_detail(resource_name: str):
...
def remove_contact(resource_name: str):
