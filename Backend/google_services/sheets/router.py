...
def read_data(spreadsheet_id: str, range: str = "Sheet1"):
    """
...
def write_data(spreadsheet_id: str, data: WriteData):
...
def append_data(spreadsheet_id: str, data: AppendData):
...
def clear_data(spreadsheet_id: str, range: str):
...
@router.post("/")
def create_new_spreadsheet(spreadsheet: SpreadsheetCreate):
...
def add_new_sheet(spreadsheet_id: str, sheet: SheetAdd):
